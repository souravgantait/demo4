function getA1Cdata() {
  ...
  aElem1.setAttribute('href','#pane1');aElem1.className ='nav-link';
  ...
  tabPane0.className='tab-pane fade in active';tabPane0.setAttribute('id','pane0');
  let tblRow0=null; let tblCell0=null;tblRow0 = document.createElement('div');
  tblRow0.classList.add('row');
  tabPane0.appendChild(tblRow0);
  tabContent.appendChild(tabPane0);
  tblRow0 = document.createElement('div');tblRow0.classList.add('row');
  tabPane0.appendChild(tblRow0);
  tabContent.appendChild(tabPane0);
  ...
  tblCell1.setAttribute('style', 'padding: 40px;');
  tblRow1.appendChild(tblCell1);
  displayTreeView(tblCell1,'Procedure','Text|Status|PerformedPeriodstart|PerformedPeriodEnd');; 
  tblCell1 = document.createElement('div');tblCell1.className='col-sm-6';
  tblCell1.setAttribute('style', 'padding: 40px;');
  tblRow1.appendChild(tblCell1);
  displayTable(tblCell1,'MedicationRequest','Text|Status|Intent');;
  tabPane1.appendChild(tblRow1);
  tabContent.appendChild(tabPane1);
