function getA1Cdata() {
  ...
  let container = document.getElementById('containerId');let ulElem = document.createElement('ul');ulElem.setAttribute('id', 'myTab');ulElem.className= 'nav nav-pills';let liElem0 = document.createElement('li');liElem0.setAttribute('class','nav-item');let aElem0= document.createElement('a');aElem0.setAttribute('href','#0');aElem0.className ='nav-link active';aElem0.innerHTML = 'Page0'ulElem0 .appendChild(liElem0 );let liElem1 = document.createElement('li');liElem1.setAttribute('class','nav-item');let aElem1= document.createElement('a');aElem1.setAttribute('href','#1');aElem1.className ='nav-link';aElem1.innerHTML = 'Page1'ulElem1 .appendChild(liElem1 );container.appendChild(ulElem);let tabContent0 = document.createElement('div');let tabContent0.className='tab-content';let tabPane0 = document.createElement('div');tabPane0.className='tab-pane fade show active';tabPane0.setAttribute('id','0');let tblRow0=null; let tblCell0=null;tblRow0 = document.createElement('div');tblRow0.classList.add('row');tabPane0.appendChild(tblRow0);tabContent0.appendChild(tabPane0);tblRow0 = document.createElement('div');tblRow0.classList.add('row');tabPane0.appendChild(tblRow0);tabContent0.appendChild(tabPane0);let tabContent1 = document.createElement('div');let tabContent1.className='tab-content';let tabPane1 = document.createElement('div');tabPane1.className='tab-pane fade show active';tabPane1.setAttribute('id','1');let tblRow1=null; let tblCell1=null;tblRow1 = document.createElement('div');tblRow1.classList.add('row'); tblCell1 = document.createElement('div');tblCell1.className='col-sm-6';tblCell1.setAttribute('style', 'padding: 40px;');tblRow1.appendChild(tblCell1);displayLine(tblCell1,'Observation','LAB (Createnine)');; tblCell1 = document.createElement('div');tblCell1.className='col-sm-6';tblCell1.setAttribute('style', 'padding: 40px;');tblRow1.appendChild(tblCell1);displayTreeView(tblCell1,'Procedure','Text|PerformedPeriodstart|Status');;tabPane1.appendChild(tblRow1);tabContent1.appendChild(tabPane1);tblRow1 = document.createElement('div');tblRow1.classList.add('row'); tblCell1 = document.createElement('div');tblCell1.className='col-sm-6';tblCell1.setAttribute('style', 'padding: 40px;');tblRow1.appendChild(tblCell1);displayBarChart(tblCell1,'Observation','VITAL SIGN (BMI)');;tabPane1.appendChild(tblRow1);tabContent1.appendChild(tabPane1);
}
